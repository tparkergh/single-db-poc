...
CREATE TABLE CWSINT.SYS_CD_C (
	SYS_ID SMALLINT NOT NULL,
	CATEGORYID SMALLINT,
	INACTV_IND CHAR(1) NOT NULL,
	OTHER_CD CHAR(2) NOT NULL,
	SHORT_DSC CHAR(40) NOT NULL,
	LGC_ID CHAR(4) NOT NULL,
	LST_UPD_ID CHAR(3) NOT NULL,
	LST_UPD_TS TIMESTAMP NOT NULL,
	THIRD_ID CHAR(10) NOT NULL,
	FKS_META_T CHAR(8) NOT NULL,
	LONG_DSC CHAR(160) NOT NULL,
	CONSTRAINT SYS_CD_C_PK PRIMARY KEY (SYS_ID)
) ;
CREATE INDEX SYSCDC1X ON CWSINT.SYS_CD_C (CATEGORYID) ;
CREATE INDEX SYSCDC22 ON CWSINT.SYS_CD_C (FKS_META_T) ;
CREATE INDEX SYSCDC33 ON CWSINT.SYS_CD_C (SHORT_DSC) ;
CREATE INDEX SYSCDC4X ON CWSINT.SYS_CD_C (LST_UPD_TS DESC) ;
CREATE UNIQUE INDEX SYSCDPPP ON CWSINT.SYS_CD_C (SYS_ID) ;
