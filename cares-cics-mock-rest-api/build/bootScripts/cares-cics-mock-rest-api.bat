...
set JARPATH=%APP_HOME%\lib\cares-cics-mock-rest-api-0.10.0-SNAPSHOT.jar

@rem Execute cares-cics-mock-rest-api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CARES_CICS_MOCK_REST_API_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
